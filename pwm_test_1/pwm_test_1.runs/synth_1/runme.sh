...
HD_PWD='C:/Users/agusn/Desktop/FPGA_CESE_Practicas/pwm_test_1/pwm_test_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_pwm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_pwm.tcl
