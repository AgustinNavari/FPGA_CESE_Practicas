...
synth_design -top top_pwm -part xc7z010clg400-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef top_pwm.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file top_pwm_utilization_synth.rpt -pb top_pwm_utilization_synth.pb"
